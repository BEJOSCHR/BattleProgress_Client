...
public class Troup_Land_LightSoldier extends Troup_Land {
	...
	public void load_TypeSettings() {
		...
		//STANDARD
		UnitStatsContainer container = Game_UnitsHandler.getUnitByName("Light Soldier");
	...
	public void load_ActionTasks() {
		...
		UnitStatsContainer mediumTank = Game_UnitsHandler.getUnitByName("Medium Soldier");
