...
public class MineProduction3 extends Upgrade{

	public MineProduction3() {
		super(UpgradeType.MineProduction3, UpgradeType.MineProduction2, ResearchCategory.Economie, 2, 0);
	}
