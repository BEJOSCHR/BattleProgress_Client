...
public class ReactorProduction3 extends Upgrade{

	public ReactorProduction3() {
		super(UpgradeType.ReactorProduction3, UpgradeType.ReactorProduction2, ResearchCategory.Economie, 2, 1);
	}
