		...
		if(GameData.dragAndDropTaskInputActive == true) {
			...
			if(targetField != null) {
				if(this.troup.targetUpgradePosition == null) {
					...
					if(this.troup.fieldIsIn_SHOT_Range(targetField)) {
						//IN RANGE
						...
						this.targetPath = new PathFinding_Algorithmus(new FieldCoordinates(this.troup.connectedField), new FieldCoordinates(targetField), true).getPath(this.troup.viewDistance, true, true);
