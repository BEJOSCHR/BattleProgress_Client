...
public class Task_Troup implements Task {
...
//==========================================================================================================
	/**
	 * The task category of all Troup Tasks
	 * @param connectedTroup - {@link Troup} - The troup, this task is revered to
	...
	public void draw_ActionBar(Graphics g, int displayedTaskNumber) {
		...
		if(this instanceof Task_Troup_Upgrade) {
			Task_Troup_Upgrade upgrTask = (Task_Troup_Upgrade) this;
			if(upgrTask.isLocked()) {
	...
	public void setToActiveTask() {
		...
		this.troup.activeTask = this;
	}

	@Override
	public void removeFromActiveTask() {
		isActiveTask = false;
		this.troup.activeTask = null;
	}
	...
	public String[] getHoverMessage() {
		if(this instanceof Task_Troup_Upgrade && ((Task_Troup_Upgrade) this).isLocked()) {
			String[] newHovermessage = {"You need to unlock the "+((Task_Troup_Upgrade) this).upgradeTroupName+"!"};
