...
public class Task_Troup_Heal extends Task_Troup{

	public Task_Troup_Heal(Troup connectedTroup) {
		super(connectedTroup, Images.taskIcon_Troup_Heal, "Heal", 11, false, true, 3, null);
		...
		if(GameData.dragAndDropTaskInputActive == true) {
			...
			if(targetField != null) {
				if(this.troup.targetUpgradePosition == null) {
					...
					if(this.troup.fieldIsIn_HEAL_Range(targetField)) {
						//IN RANGE
