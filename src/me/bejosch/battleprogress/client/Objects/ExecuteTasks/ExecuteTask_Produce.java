...
//==========================================================================================================
	...
	public void performAction() {
		...
		//================= LAND
		case "Commander":
			new Troup_Land_Commander(playerID, targetCoordinate.getConnectedField());
			break;
		case "Light Tank":
			new Troup_Land_LightTank(playerID, targetCoordinate.getConnectedField());
			break;
		case "Light Soldier":
			new Troup_Land_LightSoldier(playerID, targetCoordinate.getConnectedField());
			break;
		//================= AIR
		case "Light Heli":
			new Troup_Air_LightHelicopter(playerID, targetCoordinate.getConnectedField());
			break;
		default:
