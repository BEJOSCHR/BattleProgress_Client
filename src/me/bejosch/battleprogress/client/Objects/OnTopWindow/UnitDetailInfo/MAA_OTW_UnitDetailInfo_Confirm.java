...
public class MAA_OTW_UnitDetailInfo_Confirm extends MouseActionArea {
	...
	public MAA_OTW_UnitDetailInfo_Confirm() {
		super(WindowData.FrameWidth/2-OnTopWindowData.generalConfirm_MAA_width/2, WindowData.FrameHeight/2+OnTopWindowData.unitDetailInfo_height/2-OnTopWindowData.generallConfirm_MAA_height-20
				, WindowData.FrameWidth/2+OnTopWindowData.generalConfirm_MAA_width/2, WindowData.FrameHeight/2+OnTopWindowData.unitDetailInfo_height/2-20
