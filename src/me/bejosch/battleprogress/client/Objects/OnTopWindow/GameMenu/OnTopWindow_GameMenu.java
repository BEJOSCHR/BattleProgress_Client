...
public class OnTopWindow_GameMenu extends OnTopWindow {

	public OnTopWindow_GameMenu() {
		super("OTW_GameMenu", OnTopWindowData.menu_width, OnTopWindowData.menu_height);
	}
