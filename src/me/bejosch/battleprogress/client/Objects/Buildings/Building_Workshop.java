...
//==========================================================================================================
	...
	public void load_TypeSettings() {
		...
		//STANDARD
		UnitStatsContainer container = UnitsHandler.getUnitByName("Workshop");
		...
		String[] hoverDescription_ = {"This is a repair building","It can repair allied buildings nearby"};
