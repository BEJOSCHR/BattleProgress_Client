...
public class MouseActionArea_MultiSwitch_Str extends MouseActionArea_MultiSwitch {
	
	public List<String> possibleStates = new ArrayList<String>();
	
	
	public MouseActionArea_MultiSwitch_Str(int xTL_, int yTL_, int xBR_, int yBR_, String idName_, String[] hoverText_
			, Color standardColor_, Color hoverColor_, String connectedOTWname_, List<String> possibleStates_, int defaultPosition, int textSize_, int textYOffSet_, int arrowXOffSet_, boolean isOTWMAA) {
